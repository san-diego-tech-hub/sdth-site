...
const SocialMedia = () => (
  <aside style={{ textAlign: "center", padding: "1rem", marginTop: "1rem" }}>
    ...
    <div style={{ display: "flex", justifyContent: "space-evenly", width: "75%", margin: "auto" }}>
      <ExternalLink className="social-opacity" href="https://www.linkedin.com/company/san-diego-tech-hub/">
        <FontAwesomeIcon size="2x" icon={["fab", "linkedin"]} color="#0077B5" />
      </ExternalLink>
      <ExternalLink className="social-opacity" href="https://www.facebook.com/SanDiegoTechHub/">
        <FontAwesomeIcon size="2x" icon={["fab", "facebook-square"]} color="#3b5998" />
      </ExternalLink>
      <ExternalLink className="social-opacity" href="https://twitter.com/SanDiegoTechHub">
